...
public class Employee extends User implements Serializable {
    ...
    public void findAllCustomerAccs() {
        ...
        System.out.println("Which account would you like to see? Or press " + (files.length + 1) + " to go back.");
        ...
        for(BankAccount bA : myAccounts) {
            i++;
            if(bA.getStatus()) System.out.println(bA.toString());
        }
        ...
        i = 0;
        for(BankAccount bA : myAccounts) {
            if(bA.getStatus() == false) System.out.println(bA.toString());
        }
